...
public class HiScoreAdder {
    ...
    public void addScore(double score, String dbname) {
        ...
        if (mySQLiteAdapter.queueAll().equals("")) {
            mySQLiteAdapter.insert("1.\t\t\t----------\t\t\t1000.0");
            mySQLiteAdapter.insert("2.\t\t\t----------\t\t\t1000.0");
            mySQLiteAdapter.insert("3.\t\t\t----------\t\t\t1000.0");
            mySQLiteAdapter.insert("4.\t\t\t----------\t\t\t1000.0");
            mySQLiteAdapter.insert("5.\t\t\t----------\t\t\t1000.0");
        }
